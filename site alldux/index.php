			...
			<div class="box2">
				<div class="minimal-audio-player">
					<audio controls autoplay preload="auto">
						<source src="http://stream.zeno.fm/zupf1hqamg0uv" type="audio/mpeg">
					</audio>
				</div>
			</div>
			<div class="box">
				<div class="container2">
					<p>A <span class="highlight">Rádio Canadá Brasil</span> é uma estação de rádio digital com uma
						programação
						variada, oferecendo conteúdo cultural e musical que conecta o Brasil e o Canadá. Disponível
						online,
						a
						rádio permite que ouvintes em diferentes partes do mundo aproveitem sua transmissão ao vivo por
						meio
						de
						plataformas acessíveis em dispositivos móveis.</p>
					<p>Com gêneros musicais e temas culturais diversificados, a rádio se destaca por oferecer uma
						conexão
						multicultural, sendo uma excelente escolha para quem deseja se conectar com conteúdo
						internacional
						de
						qualidade.</p>
					<div class="link">
						<a href="https://radiocanadabrasil.com/" target="_blank">Visite o site da Rádio Canadá
							Brasil</a>
					</div>
				</div>
			</div>
