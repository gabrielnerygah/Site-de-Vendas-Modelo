...
<body class="dark-mode">
    ...
    <div class="auth-container">
        ...
        <div class="form-container">
            ...
            <div class='form-message' id='mensagem_retorno'>
                <?php
                if (isset($_GET['error'])) {
    ...
    <script>
        ...
        container.addEventListener('click', async () => {
            ...
            try {
                const response = await fetch('processalogin.php', {
                    method: 'POST',
                    body: formData
                });
                ...
                if (result.success) {
                    mensagemRetorno.innerHTML = `<div class='form-message success'>${result.message}</div>`;
                    ...
                    mensagemRetorno.innerHTML = `<div class='form-message error'>${result.message}</div>`;
                ...
                container.classList.remove('active');
                mensagemRetorno.innerHTML = `<div class='form-message error'>Erro de conexão. Tente novamente.</div>`;
                container.classList.add('error');
